...
import AlramNew from "../assets/images/img_alarm_new.png";
import AlramDone from "../assets/images/img_alarm_done.png";
            ...
            >
                <Stack>
                    <Stack direction="row" p={3} justifyContent="space-between">
                        ...
                        <Typography onClick={() => dispatch(toggle())}>닫기</Typography>
                    </Stack>
