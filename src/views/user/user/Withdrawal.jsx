        ...
        <>
            <Dialog open={open} onClose={() => setOpen(false)} fullWidth maxWidth="md">
                <Stack p={3} spacing={3}>
                    ...
                    <Stack direction="row" spacing={3} justifyContent="center">
                        ...
                        <Button onClick={handleClickSubmit} variant="contained" sx={{ alignSelf: "center" }} size="small">
                            탈퇴 신청
                        </Button>
                    </Stack>
                </Stack>
            ...
            <Dialog open={openAlert} onClose={() => setOpenAlert(false)}>
                <Stack p={5} spacing={3} textAlign="center">
                    ...
                    <Button size="small" variant="contained" sx={{ alignSelf: "center" }} onClick={() => setOpenAlert(false)}>
                        확인
                    </Button>
                </Stack>
            </Dialog>
            ...
            <Dialog open={openComplete}>
                <Stack p={5} spacing={3} textAlign="center">
                    ...
                    <Button size="small" variant="contained" sx={{ alignSelf: "center" }} onClick={handleClickComplete}>
                        확인
                    </Button>
                </Stack>
            </Dialog>
