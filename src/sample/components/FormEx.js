...
const SCHEMA_SEARCH = {
    __form__: "search",
    text_1: { type: "text", label: "text", required: true, leftButton: { icon: "up" }, rightButton: { icon: "search" }, rightText: "kg", leftText: "cm" },
    ...
    between: {
        ...
        leftText: "aqwdqwda",
        schema: { begin1: { type: "date", required: true, leftText: "aa", rightButton: { icon: "search" } }, end1: { type: "date", required: true } },
    },
    between1: {
        type: "between",
        label: "between 2",
...
export const FormEx = () => {
    const { schema, setSchema, setEditable, getValues, handleSubmit, setValue, clearErrors, resetSchema, validate, clearValues } = useForm({
