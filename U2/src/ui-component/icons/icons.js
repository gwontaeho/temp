...
export const HomeIcon = (props) => {
    return <img src={props?.selected ? btn_navi_home_p : btn_navi_home_n} width="30px" height="30px" alt="home icon" />;
};

export const MessageIcon = (props) => {
    return <img src={props?.selected ? btn_navi_reserve_p : btn_navi_reserve_n} width="30px" height="30px" alt="message icon" />;
};

export const ListIcon = (props) => {
    return <img src={props?.selected ? btn_navi_send_p : btn_navi_send_n} width="30px" height="30px" alt="list icon" />;
};

export const TemplateIcon = (props) => {
    return <img src={props?.selected ? btn_navi_templete_s : btn_navi_templete_n} width="30px" height="30px" alt="template icon" />;
};

export const SubscriptionIcon = (props) => {
    return <img src={props?.selected ? btn_navi_subs_s : btn_navi_subs_n} width="30px" height="30px" alt="subscription icon" />;
};

export const SettingIcon = (props) => {
    return <img src={props?.selected ? btn_navi_setting_s : btn_navi_setting_n} width="30px" height="30px" alt="setting icon" />;
};

export const MenuIcon = (props) => {
    return <img src={props?.selected ? btn_menu_p : btn_menu_n} width="33px" height="32px" alt="menu icon" />;
};
...
export const ListViewIcon = (props) => {
    return <img src={props.selected ? btn_view_list_s : btn_view_list_n} width="25px" height="24px" alt="list view" />;
};

export const CardViewIcon = (props) => {
    return <img src={props.selected ? btn_view_img_s : btn_view_img_n} width="25px" height="24px" alt="card view" />;
};
...
export const CloseIcon = (props) => {
    return <img src={props.selected ? btn_popup_close_p : btn_popup_close_n} width="34px" height="34px" alt="close icon" />;
};

// 체크박스

export const CheckboxIcon = (props) => {
    return <img src={props.checked ? btn_check_s : btn_check_n} width="34px" height="34px" alt={`${props.checked ? "" : "non"}checked icon`} />;
};

// 라디오

export const RadioIcon = (props) => {
    return <img src={props.checked ? btn_radio_s : btn_radio_n} width="18px" height="18px" alt={`${props.checked ? "" : "non"}checked icon`} />;
};
